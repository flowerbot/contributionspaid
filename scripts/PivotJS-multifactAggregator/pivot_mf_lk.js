...
// using subtotalCopy.js as a guide, trying to cram this code to work with the main subtotal.js code
(function() {
        var callWithJQuery,
    ...
    callWithJQuery(function ($) {
        ...
        /*
         Utilities
         */
        var mfPivotData, mfAddSeparators, aggregatorTemplates, aggregators, dayNamesEn, derivers, locales, mfTableRenderer, mthNamesEn, naturalSort, numberFormat, pivotTableRenderer, renderers, usFmt, usFmtInt, usFmtPct, zeroPad;
        mfAddSeparators = function (nStr, thousandsSep, decimalSep) {
            var rgx, x, x1, x2;
            nStr += '';
            x = nStr.split('.');
            x1 = x[0];
        ...
        $.pivotUtilities.mfAggregatorTemplates = mfAggregatorTemplates;
        return $.pivotUtilities.mf_aggregators = (function(tpl, sTpl) {
          return {
     ...
     /*   $.pivotUtilities = {
        ...
        /*
         Data Model class
         */
        mfPivotData = (function (superClass) {
            var processKey;
            extend(mfPivotData, superClass);

            function mfPivotData(input, opts) {
             mfPivotData.__super__.constructor.call(this, input, opts);
            ...
            mfPivotData.prototype.processRecord = function (input, derivedAttributes, f) {
            ...
            mfPivotData.convertToArray = function (input) {
                var result;
                result = [];
                mfPivotData.forEachRecord(input, {}, function (record) {
                    return result.push(record);
                });
                return result;
            };

            mfPivotData.prototype.natSort = function (as, bs) {
                return naturalSort(as, bs);
            };

            mfPivotData.prototype.arrSort = function (a, b) {
                return this.natSort(a.join(), b.join());
            };

            mfPivotData.prototype.sortKeys = function () {
                if (!this.sorted) {
            ...
            mfPivotData.prototype.getColKeys = function () {
                this.sortKeys();
                return this.colKeys;
            };

            mfPivotData.prototype.getRowKeys = function () {
                this.sortKeys();
                return this.rowKeys;
            };

            mfPivotData.prototype.processRecord = function (record) {
            ...
            mfPivotData.prototype.getAggregator = function (rowKey, colKey) {
         ...
         */
        mfTableRenderer = function (mfPivotData, opts) {
            ...
            val = void 0;
            x = void 0;
            valAttrs = mfPivotData.valAttrs;
            colAttrs = mfPivotData.colAttrs;
            rowAttrs = mfPivotData.rowAttrs;
            rowKeys = mfPivotData.getRowKeys();
            colKeys = mfPivotData.getColKeys();
            colSpanArray = [];
            ...
            for (j in colAttrs) {
                ...
                tmpAggregator = mfPivotData.getAggregator([], []);
            ...
            if (rowAttrs.length !== 0) {
               ...
               // console.log("colSpanArray:", colSpanArray);
                ...
                if (tmpAggregator.multivalue) {
                    ...
                    th = $("<th>");
                    if (colAttrs.length === 0) {
                        th.addClass("pvtTotalLabel").text("Total");
                    }
                    tr.append(th);
                }
                result.append(tr);
            ...
            for (i in rowKeys) {
                ...
                for (j in colKeys) {
                    colKey = colKeys[j];
                    aggregator = mfPivotData.getAggregator(rowKey, colKey);
                ...
                totalAggregator = mfPivotData.getAggregator(rowKey, []);
           ...
           // th.attr("colspan", rowAttrs.length + (colAttrs.length === 0 ? 0 : 1));
            ...
            for (j in colKeys) {
                colKey = colKeys[j];
                totalAggregator = mfPivotData.getAggregator([], colKey);
                if (totalAggregator.multivalue) {
                    val = totalAggregator.multivalue();
                    for (v in val) {
            ...
            totalAggregator = mfPivotData.getAggregator([], []);
        ...
        pivotTableRenderer = function (mfPivotData, opts) {
        ...
        /*
         Pivot Table core: create mfPivotData object and call Renderer on it
         */
        $.fn.pivot = function (input, opts) {
            var defaults, e, mfPivotData, result, x;
            defaults = {
                cols: [],
                rows: [],
                filter: function () {
            ...
            result = null;
            try {
                mfPivotData = new mfPivotData(input, opts);
                try {
                    result = opts.renderer(mfPivotData, opts.rendererOptions);
                } catch (_error) {
                    e = _error;
        ...
        $.fn.pivotUI = function (input, inputOpts, overwrite, locale) {
            ...
            try {
                input = mfPivotData.convertToArray(input);
                tblCols = (function () {
                    var _ref, _results;
                    _ref = input[0];
                    _results = [];
                ...
                mfPivotData.forEachRecord(input, opts.derivedAttributes, function (record) {
